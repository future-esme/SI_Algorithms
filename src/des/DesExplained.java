...
public class DesExplained {
    private static final String RESET = "\u001B[0m";
    private static final String RED = "\u001B[31m";
    private static final String BLUE = "\u001B[34m";


    //matrice folosita pentru a efectua substitutii in etapa de permutare si substitutie
    //sunt 8 in total
    //fiecare s box primeste 6 biti ca intrare si produce 4 biti de iesire
    ...
    //utilizat pentru a efectua operatii de permutare asupra datelor
    //specifica cati biti trebuie sa fie rotiti in stanga sau in dreatpa in fiecare runda
    //sunt 16 elemente pentru ca sunt 16 runde
    ...
    //folosit pentru a rearanja bitii din blocul de date original inainte de inceperea rundelor de criptare
    ...
    //specifica permutare si selectie a bitilor din cheia principala
    //pentru a genera o cheie de 56 biti
    ...
    //este utilizată pentru a efectua o altă permutare și selecție
    //asupra cheii intermediare de 56 de biți obținute din permCho1.
    ...
    //Această matrice are un scop specific, și anume să mărească numărul de biți ai datelor,
    // astfel încât să poată fi efectuată operația XOR cu subcheia curentă,
    // care are 48 de biți, pentru a produce un rezultat de 48 de biți.
    ...
    //este utilizată pentru a efectua o permutare finală a datelor criptate în cadrul fiecărei runde de criptare.
...
/*
* Inițializare și pregătirea datelor:

Mesajul și cheia sunt convertite din format hexazecimal în format binar.
Mesajul este supus permutării inițiale (initialPermutation) folosind matricea initialPerm, pentru a obține un bloc de 64 de biți.
Generarea subcheilor:

Cheia inițială este supusă permutării și selecției cu ajutorul matricei permCho1, reducându-se la 56 de biți.
Cheia este împărțită în două părți: "leftKey" și "rightKey".
Se efectuează 16 iterații, unde fiecare parte a cheii este rotită la stânga cu un număr specific de poziții, conform matricei "shiftTable".
Apoi, cele două părți sunt combinate și supuse unei noi permutări cu ajutorul matricei permCho2. Rezultatul este o listă de 16 subchei, în format binar și hexazecimal.
Criptare sau Decriptare:

În fiecare dintre cele 16 runde, blocul de mesaj este împărțit în două părți: "leftMessage" și "rightMessage".
Partea "rightMessage" este extinsă (expansion permutation) utilizând matricea expanPerm pentru a obține 48 de biți.
Se realizează un XOR între "rightExpand" și subcheia corespunzătoare acelei runde.
Pentru fiecare dintre cele 8 cutii S-box (S-boxes sunt matrici multidimensionale), se efectuează operații de substituție, în care se transformă cei 48 de biți în 32 de biți,
conform regulilor matricelor S-box.
Partea "leftMessage" este supusă unei operații de XOR cu rezultatul din S-box.
La sfârșitul fiecărei runde, cele două părți ale mesajului sunt interschimbate și pregătite pentru următoarea rundă.
Finalizare:

După cele 16 runde, cele două părți ale mesajului sunt combinate și supuse unei permutări finale (finalPermutation) cu ajutorul matricei finalPerm.
Rezultatul final este blocul de date criptat sau decriptat, care este returnat sub forma unui șir binar.*/